{
  description = "A plymouth theme with PacMan, Glowing and CSD Logo";
    ...
    in
    {
      packages.${system} = {
        ...
        preview = pkgs.writeShellScriptBin "preview" ''
          ...
          }/bin/plymouthFHSEnv -c 'plymouthd --debug ; plymouth show-splash ; sleep 1s ; plymouth display-message --text="A que bonjour ÉéêâôÔ !" ; sleep 1s ; plymouth ask-for-password --prompt=coucou ; sleep 5s ; plymouth quit'
        '';
